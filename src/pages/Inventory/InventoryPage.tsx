...
import { LocationManagement, type LocationManagementHandle } from '@/features/inventory/components/LocationManagement';
...
export const InventoryPage: React.FC = () => {
  ...
  const [locationAddRequestSeq, setLocationAddRequestSeq] = useState(0);

  const [locationSearchQuery, setLocationSearchQuery] = useState('');

  const locationSearchInputRef = useRef<HTMLInputElement>(null);

  const locationManagementRef = useRef<LocationManagementHandle>(null);
  ...
  useEffect(() => {
    ...
    const frame = requestAnimationFrame(() => {
      ...
      locationManagementRef.current?.focusTreePanel();
  ...
  const requestAddLocation = useCallback(() => {

    setLocationAddRequestSeq((n) => n + 1);

  }, []);



  const handleLocationSearchKeyDown = useCallback(

    (e: React.KeyboardEvent<HTMLInputElement>) => {

      const tree = locationManagementRef.current;
    ...
    if (activeTab === 'locations') {
      ...
      return (
        ...
        <>
          ...
          <div className="inventory-header-location-search">
            ...
            <Input
              ...
              className="inventory-header-location-search__input"
            ...
            {locationSearchQuery ? (
              ...
              <button
                ...
                className="inventory-header-location-search__clear"
          ...
          <ModuleHeaderPrimaryButton onClick={requestAddLocation} title="Add a new location">
  ...
  return (
    ...
    <div className="inventory-page">
      ...
      <div
        className={`inventory-page-content${activeTab === 'locations' ? ' inventory-page-content--locations-fill' : ''}`}
      >
        ...
        {activeTab === 'locations' && (
          ...
          <LocationManagement
            ...
            ref={locationManagementRef}

            locationId={searchParams.get('locationId') || undefined}

            searchQuery={locationSearchQuery}

            addLocationRequestSeq={locationAddRequestSeq}
